  ...
  return (
    <>
      ...
      <div className='p-3 w-full flex flex-col justify-center items-center'>
        ...
        <div className=' md:w-[50%] lg:w-[38%] p-3 flex flex-col-reverse gap-5 md:gap-0 md:flex-row justify-evenly items-center'>
        ...
        <div className='  w-[35%] p-3 flex justify-evenly items-center'>
          <HiOutlineArrowNarrowDown color='' size={30} className='downArrow'/>
        </div>
