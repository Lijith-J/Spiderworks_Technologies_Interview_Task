            ...
            <div className='fixed z-10 top-[15px] sm:top-[20px] w-full flex justify-center second-navbar-parent'>
                ...
                <div className=' w-[85%] sm:[85%] md:w-[70%] lg:w-[50%] h-[60px] rounded-lg p-2 gap-2 flex justify-around second-navbar-items-div'>
                    ...
                    <div className='p-2 flex gap-2 justify-evenly items-center'>
                        ...
                        <div className='bg-gray-900 px-5 py-[6px] rounded-full hidden sm:flex gap-2 justify-center items-center cursor-pointer'>
                        ...
                        <div className=' rounded-full p-[2px] flex justify-center items-center cursor-pointer second-navbar-message-button'>
                            <div className='bg-white px-3 py-[6px] rounded-full flex items-center gap-2'>
                    ...
                    <div className=' h-full lg:p-2 flex justify-center items-center '>
                        ...
                        <div className='bg-gray-900 flex p-1 gap-1 lg:gap-1 items-center rounded-full cursor-pointer'>

                            <div className=' bg-white sm:p-1 rounded-full'>
                                <img src={searchIcon} className='w-[20px] sm:w-[25px]' alt="" />
                            </div>

                            <div className=' text-white flex p-[5px] lg:p-2 items-center justify-center'>
